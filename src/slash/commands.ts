...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  // ---------------- Format inline ----------------
  {
    ...
    names: ["gras", "bold", "b"],
    label: "Gras",
    hint: "**…** · Entrée pour sortir",
    group: "format",
    run: (ctx) => startLiveFormat(ctx, "bold"),
  },
  {
    id: "italic",
    ...
    hint: "*…* · Entrée pour sortir",
    group: "format",
    run: (ctx) => startLiveFormat(ctx, "italic"),
  },
  {
    id: "strike",
    ...
    hint: "~~…~~ · Entrée pour sortir",
    group: "format",
    run: (ctx) => startLiveFormat(ctx, "strike"),
  },
  {
    id: "inline-code",
